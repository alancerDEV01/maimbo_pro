...
export const benefits = [
  { title: "Envíos a todo Perú", detail: "Despacho en 24–48h" },
  { title: "Pago seguro", detail: "Checkout protegido" },
  { title: "Cambios de talla", detail: "Hasta 7 días" },
  { title: "WhatsApp directo", detail: "Atención real" },
  { title: "Tienda física", detail: "Gamarra · Lima" },
];
